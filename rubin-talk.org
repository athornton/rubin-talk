...
* A Brief Overview of the Rubin Observatory (2022)
...
*** Summit Facilty, May 2022

[[./assets/Summit-Dusk-2022-05-15.jpg]]
...
- Finishing construction of the observatory building.
- Connecting up the different telescope components and discovering where
  integration is lacking.
- Uncovering redundancy/network design flaws.
...
Grand total, one billion dollars in round numbers.  Actually rather
more, since there's been considerable inflation since 2013, and also
because we kept paying people to work on things while the schedule
slipped due to COVID-19 delays.  Some of that work will accelerate the
schedule later, but not all of it.
...
I am now working on the third iteration of the service that supplies
users with the notebook platform.

Most of 2022, though, I have been working on monitoring and telemetry
for the Science Platform framework.  This is derived from the
Engineering Facilities Database we built for the components in the dome;
we can leverage this work to keep track of the health and performance of
internal components of our Science Platform.
