...
- The mirrors are on the telescope.
- The commissioning camera (144 MPx) is in place.
- We took our first pictures of the sky on Oct. 24, 2024.
- Early next year: install the full camera.
- Then do more calibration.
- And finally start the survey in late 2025.
